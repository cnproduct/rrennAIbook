...
import { createrrennAIbook } from "./index.js";
import fs from "fs";
...
async function run() {
  console.log();
  console.log(chalk.bold("Welcome to rrennAIbook!"));
  console.log();
  ...
  if (!bookPath) {
    ...
    console.log(
      `  ${chalk.cyan("npm create rrennAIbook")} ${chalk.green("<book-directory>")}`,
    );
    console.log();
    console.log("For example:");
    console.log(
      `  ${chalk.cyan("npm create rrennAIbook")} ${chalk.green("my-new-book")}`,
    );
    console.log();
    process.exit(1);
  }
  ...
  console.log();
  console.log(`Creating a new rrennAIbook...`);
  console.log();

  const result = await createrrennAIbook({
    bookPath,
    description,
    author,
    authorUrl,
  ...
  if (!result.success) {
    console.error(chalk.red("Error creating rrennAIbook:"), result.error);
    process.exit(1);
  }
  ...
  console.log();
  console.log(chalk.cyan(`  rrennAIbook dev`));
  console.log("    Starts the development server.");
  console.log();
  console.log(chalk.cyan(`  rrennAIbook build`));
