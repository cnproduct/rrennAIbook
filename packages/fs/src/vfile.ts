...
export const getMarkdown = async (
  ...
  const rrennAIbook = await getJson(file.root);
  ...
  return {
    content,
    data: { ...data } as rrennAIbookFrontmatter,
  };
};
