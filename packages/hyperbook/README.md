...
The main CLI tool for creating, building, and serving rrennAIbook projects. rrennAIbook is a quick and easy way to build interactive workbooks that support modern standards and run superfast.

## Features

- **Quick Project Setup** - Scaffold new projects with `rrennAIbook new`
...
```sh
npm install -g rrennAIbook
# or
pnpm add -g rrennAIbook
```

Or use directly with npx:

```sh
npx rrennAIbook@latest new my-book
```

## Usage

### Create a new rrennAIbook project

```sh
rrennAIbook new my-documentation
cd my-documentation
```
...
A rrennAIbook project consists of:

```
my-book/
├── rrennAIbook.json          # Main configuration
...
The `rrennAIbook.json` file configures your project:
