...
Markdown processing engine for rrennAIbook. This package provides extensive markdown transformation capabilities with 30+ custom directives and plugins:
...
```sh
pnpm add @rrennAIbook/markdown
# or
npm i @rrennAIbook/markdown
```
