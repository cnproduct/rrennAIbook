...
rrennAIbook.youtube = rrennAIbook.youtube || {};

rrennAIbook.youtube.consent = (function () {
  var CONSENT_ID = "youtube";

  async function isAllowed() {
    try {
      var entry = await rrennAIbook.store.db.consent.get(CONSENT_ID);
  ...
  async function allow() {
    await rrennAIbook.store.db.consent.put({ id: CONSENT_ID, allowed: true });
  }
