...
async function postbuild() {
  ...
  const zipFiles = [
    {
      url: "https://github.com/openpatch/sql-ide/releases/download/v2.0.0-rrennAIbook.2/dist-embedded.zip",
      dst: path.join("./dist", "assets", "directive-sqlide", "include"),
    },
    {
      url: "https://github.com/openpatch/online-ide/releases/download/v2.2.1-rrennAIbook.5/dist-embedded.zip",
