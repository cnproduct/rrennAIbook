import { rrennAIbookPage } from "@rrennAIbook/types";
...
export const evaluateQuery = (query: QueryNode | null, page: rrennAIbookPage & Record<string, unknown>): boolean => {
  if (query === null) {
    return true;
  }
...
export const evaluateCondition = (field: string, regex: string, page: rrennAIbookPage & Record<string, unknown>): boolean => {
