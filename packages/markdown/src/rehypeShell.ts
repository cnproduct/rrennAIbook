...
const makeAuthorElement = (ctx: rrennAIbookContext): ElementContent => {
  ...
  return {
    ...
    properties: {
      class: "author",
      href: "https://rrennAIbook.openpatch.org",
      ...(showTooltip ? { title: `rrennAIbook v${ctx.version}` } : {}),
    },
    children: [
      {
        type: "text",
...
const buildBreadcrumbPath = (
  ...
  const findPath = (
    sections: rrennAIbookSection[],
    pages: rrennAIbookPage[],
...
const makeBreadcrumbElements = (ctx: rrennAIbookContext): ElementContent[] => {
...
type NavigationItem = 
  | { type: "page"; item: rrennAIbookPage }
  | { type: "section"; item: rrennAIbookSection };

const makeNavigationElements = (ctx: rrennAIbookContext): ElementContent[] => {
...
const makeMetaElements = (ctx: rrennAIbookContext): ElementContent[] => {
  const elements: ElementContent[] = [];
  ...
  if (ctx.config.importExport) {
    elements.push({
      ...
      properties: {
        href: "#",
        onclick: "rrennAIbook.store.export()",
      },
      children: [
        {
          type: "element",
          ...
          properties: {
            class: "export-icon",
            title: i18n.get("shell-export-rrennAIbook"),
          },
          children: [],
        },
      ],
    ...
    elements.push({
      ...
      properties: {
        href: "#",
        onclick: "rrennAIbook.store.import()",
      },
      children: [
        {
          type: "element",
          ...
          properties: {
            class: "import-icon",
            title: i18n.get("shell-import-rrennAIbook"),
          },
          children: [],
        },
      ],
  ...
  elements.push({
    ...
    properties: {
      href: "#",
      onclick: "rrennAIbook.store.reset()",
    },
    children: [
      {
        type: "element",
        ...
        properties: {
          class: "reset-icon",
          title: i18n.get("shell-reset-rrennAIbook"),
        },
        children: [],
      },
    ],
...
const linkLicense = (ctx: rrennAIbookContext): ElementContent => {
...
const makeHeaderElements = (ctx: rrennAIbookContext): ElementContent[] => {
  const { config } = ctx;
  const elements: ElementContent[] = [];
    ...
    children: [
      {
        ...
        properties: {
          ...
          class: "toggle",
          onclick: "rrennAIbook.ui.navToggle()",
        },
        children: [
          {
            type: "element",
  ...
  if (ctx.config.search) {
    elements.push({
      ...
      properties: {
        id: "search-toggle",
        onclick: "rrennAIbook.ui.searchToggle()",
  ...
  elements.push({
    ...
    properties: {
      ...
      onclick: "rrennAIbook.share.open()",
    },
    children: [
      {
        type: "element",
  ...
  if (config.cloud) {
    elements.push({
      ...
      properties: {
        ...
        class: "icon-button",
        title: "User",
        onclick: "rrennAIbook.cloud.userToggle()",
      },
      children: [
        {
          type: "element",
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  tagName: "button",
                  properties: {
                    onclick: "rrennAIbook.cloud.login()",
                  },
                  children: [
                    {
                      type: "text",
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  tagName: "button",
                  properties: {
                    onclick: "rrennAIbook.cloud.save()",
                  },
                  children: [
                    {
                      type: "text",
                ...
                },
                {
                  ...
                  tagName: "button",
                  properties: {
                    onclick: "rrennAIbook.cloud.logout()",
                    class: "logout-btn",
                  },
                  children: [
                    {
...
const makeJump = (ctx: rrennAIbookContext): ElementContent[] => {
  const elements: ElementContent[] = [];
...
const makeSidebar = (ctx: rrennAIbookContext): ElementContent[] => {
  const elements: ElementContent[] = [
    ...makeNavigationElements(ctx),
    makeAuthorElement(ctx),
  ];
...
const makeCustomLinksFooter = (ctx: rrennAIbookContext) => {
  const elements: ElementContent[] = [];
  if (ctx.config.links) {
    elements.push({
      type: "element",
