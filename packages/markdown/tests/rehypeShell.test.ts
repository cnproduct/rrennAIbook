...
describe("rehypeShell", () => {
  const virtualCtx: rrennAIbookContext = {
    ...ctx,
    navigation: {
      ...ctx.navigation,
      sections: [
  ...
  it("should apply default layout class when no layout is specified", () => {
    const defaultCtx: rrennAIbookContext = {
      ...ctx,
      navigation: {
        ...ctx.navigation,
        current: {
  ...
  it("should apply wide layout class when layout is set to wide", () => {
    const wideCtx: rrennAIbookContext = {
      ...ctx,
      navigation: {
        ...ctx.navigation,
        current: {
  ...
  it("should apply default layout class when layout is explicitly set to default", () => {
    const defaultExplicitCtx: rrennAIbookContext = {
      ...ctx,
      navigation: {
        ...ctx.navigation,
        current: {
  ...
  it("should apply standalone layout class when layout is set to standalone", () => {
    const standaloneCtx: rrennAIbookContext = {
      ...ctx,
      navigation: {
        ...ctx.navigation,
        current: {
  ...
  it("should render breadcrumb when enabled globally", () => {
    const breadcrumbCtx: rrennAIbookContext = {
      ...ctx,
      config: {
        ...ctx.config,
        breadcrumb: true,
  ...
  it("should not render breadcrumb when disabled", () => {
    const noBreadcrumbCtx: rrennAIbookContext = {
      ...ctx,
      config: {
        ...ctx.config,
        breadcrumb: false,
  ...
  it("should not render breadcrumb on root index page", () => {
    const rootCtx: rrennAIbookContext = {
      ...ctx,
      config: {
        ...ctx.config,
        breadcrumb: true,
