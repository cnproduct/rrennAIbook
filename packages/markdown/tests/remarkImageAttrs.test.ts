...
export const toHtml = (md: string, ctx: rrennAIbookContext) => {
  return unified()
    .use(remarkParse)
    .use(remarkLink(ctx))
...
`,
      ...
      <p>
        <figure src="/public/left.jpg" alt="Alt" class="normal align-left">
          <img class="align-left" src="/public/left.jpg" alt="Alt" onclick="rrennAIbook.ui.toggleLightbox(this)">
        </figure>
      </p>
      "
    `);
...
`,
      ...
      <p>
        <figure src="/public/leftplus.jpg" alt="Alt" class="normal align-leftplus">
          <img class="align-leftplus" src="/public/leftplus.jpg" alt="Alt" onclick="rrennAIbook.ui.toggleLightbox(this)">
        </figure>
      </p>
      "
    `);
...
`,
      ...
      <p>
        <figure src="/public/right.jpg" alt="Alt" class="normal align-right">
          <img class="align-right" src="/public/right.jpg" alt="Alt" onclick="rrennAIbook.ui.toggleLightbox(this)">
        </figure>
      </p>
      "
    `);
...
`,
      ...
      <p>
        <figure src="/public/rightplus.jpg" alt="Alt" class="normal align-rightplus">
          <img class="align-rightplus" src="/public/rightplus.jpg" alt="Alt" onclick="rrennAIbook.ui.toggleLightbox(this)">
        </figure>
      </p>
      "
    `);
...
`,
      ...
      <p>
        <figure src="/public/centerplus.jpg" alt="Alt" class="normal align-centerplus">
          <img class="align-centerplus" src="/public/centerplus.jpg" alt="Alt" onclick="rrennAIbook.ui.toggleLightbox(this)">
        </figure>
      </p>
      "
    `);
...
`,
      ...
      <p>
        <figure src="/public/normal.jpg" alt="" class="normal rounded">
          <img width="200" id="hero" class="rounded" src="/public/normal.jpg" alt="" onclick="rrennAIbook.ui.toggleLightbox(this)">
        </figure>
      </p>
      "
    `);
