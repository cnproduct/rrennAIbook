...
- [`4221fe1`](https://github.com/openpatch/rrennAIbook/commit/4221fe145a6dfffd9f97459fa2d2694da4b5d78e) Thanks [@mikebarkmin](https://github.com/mikebarkmin)! - add global configuration options for onlineide and sqlide
...
- [#363](https://github.com/openpatch/rrennAIbook/pull/363) [`5ca2ccf`](https://github.com/openpatch/rrennAIbook/commit/5ca2ccfec72a841ec9c4e43a03ceb2be68710541) Thanks [@mikebarkmin](https://github.com/mikebarkmin)! - Add custom links support. Custom links can now be configured in your `rrennAIbook.json`. See the book configuration documentation for more information on how to set them up.
