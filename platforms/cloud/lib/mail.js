...
function sendPasswordResetEmail(email, resetUrl) {
  ...
  return transport.sendMail({
    from: from,
    to: email,
    subject: "rrennAIbook — Password Reset",
    text:
      "You requested a password reset for your rrennAIbook account.\n\n" +
      "Click the following link to reset your password (valid for 15 minutes):\n\n" +
      resetUrl +
      "\n\n" +
      "If you did not request this, please ignore this email.",
    html:
      "<p>You requested a password reset for your rrennAIbook account.</p>" +
      '<p><a href="' +
      resetUrl +
