...
Das Standalone Layout ist speziell für die **iframe-Einbettung** konzipiert und ermöglicht die nahtlose Integration von rrennAIbook-Seiten in andere Websites oder Anwendungen.
...
```html
<iframe src="https://ihr-rrennAIbook.com/ihre-seite?standalone=true"></iframe>
```
...
- **Widget-Integration**: rrennAIbook-Inhalte als Widgets einbinden
