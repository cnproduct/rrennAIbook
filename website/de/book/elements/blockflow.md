...
[Blockflow](https://blockflow.openpatch.org) ist ein Fork von Scratch zum Erstellen von geführten Tutorials. rrennAIbook bietet zwei Direktiven zum Einbetten von Blockflow: einen **Player** zum Abspielen und einen **Editor** zum Erstellen von Tutorials.
...
```md
::blockflow-player{src="https://rrennAIbook.openpatch.org/elements/platformer.sb3"}
```
