...
::excalidraw{src="/excalidraw/rrennAIbook.excalidraw" aspectRatio="4/3" autoZoom=false edit=true}
```
...
:::alert{info}
Versichere dich, dass du die richtige Sprache in der `rrennAIbook.json` gesetzt hast, anderenfalls wird Excalidraw auf Englisch angezeigt.
:::
...
Du kannst die Standardwerte des Excalidraw-Elements in der `rrennAIbook.json` ändern.
