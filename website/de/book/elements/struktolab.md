...
Struktolab ermöglicht es Ihnen, Struktogramme in Ihrem rrennAIbook anzuzeigen. Sie können es im Ansichtsmodus verwenden, um Struktogramme anzuzeigen, oder im Bearbeitungsmodus, um Struktogramme direkt in Ihrem rrennAIbook zu erstellen und zu bearbeiten.
...
- `scale`: number
- `fontSize`: number
- `lang`: "de" | "en" uses the rrennAIbook language by default
