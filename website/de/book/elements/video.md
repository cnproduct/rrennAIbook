...
Das Video-Element erlaubt das Anzeigen eines Videos im rrennAIbook als [_Video Embed element_](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video).
