...
Sometimes you want a repeated layout in your rrennAIbook. With templates, you can do that.
You can define a template by placing it in the `templates` folder at the root of your rrennAIbook.
