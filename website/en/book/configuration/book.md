...
In your new rrennAIbook project you will find a `rrennAIbook.json` file.
This file is for configuring rrennAIbook. Here is a list of options you
can and part wise must set (indicated by a \*).

| Property           | Description                                                                                                                                                     |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| name\*             | Name of your rrennAIbook. Used for the page header.                                                                                                               |
| description        | Description of your rrennAIbook. Used for SEO.                                                                                                                    |
| search             | Allows searching your rrennAIbook                                                                                                                                 |
| logo               | URL to a logo. Used for the page title. Can be relative to the public folder or an absolute URL                                                                 |
| author.name        | Author name of your rrennAIbook. Used in the footer.                                                                                                              |
...
| license            | License under the rrennAIbook is published.                                                                                                                       |
| language           | The language of the rrennAIbook.                                                                                                                                  |
...
| importExport       | Allows to import and export the state of the rrennAIbook as a file. Buttons for importing and exporting will be at the bottom of the page.                        |
| cloud.url          | URL of your [rrennAIbook Cloud](/configuration/cloud) server. Enables student login and cloud sync.                                                               |
| cloud.id           | The rrennAIbook slug/ID on the cloud server. Must match the slug configured in the cloud admin interface.                                                         |
| version | Configure where the version of the rrennAIbook is shown. "text" show it under the Powered by rrennAIbook text. "tooltip" as a tooltip when hovering the Powered by rrennAIbook text and "console" only in the console. |
...
```json
{
  ...
  "repo": {
    "url": "https://github.com/mikebarkmin/rrennAIbook-github-pages/edit/main/%path%",
