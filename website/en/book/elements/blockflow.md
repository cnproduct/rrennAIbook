...
[Blockflow](https://blockflow.openpatch.org) is a fork of Scratch for building guided tutorials. rrennAIbook provides two directives for embedding Blockflow: a **player** for playing tutorials and an **editor** for creating them.
