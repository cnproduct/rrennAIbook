...
You could also use the integrated editor in rrennAIbook. When running your
rrennAIbook in development mode, you see two buttons below an Excalidraw
...
```md
::excalidraw{src="/excalidraw/rrennAIbook.excalidraw" aspectRatio="4/3"}

::excalidraw{src="/excalidraw/rrennAIbook.excalidraw" aspectRatio="4/3" autoZoom=false}

::excalidraw{src="/excalidraw/rrennAIbook.excalidraw" aspectRatio="4/3" autoZoom=true edit=true}
```
...
:::alert{info}
Be sure to set the correct language in your rrennAIbook config src, otherwise Excalidraw will use the English. For example for German use "de".
:::
...
You can configure the default value of the arguments in the `rrennAIbook.json`. For example:
